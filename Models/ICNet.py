...
def ICNet(n_classes, input_height=640, input_width=320, weights_path=None):
    ...
    #else:
    o_shape = Model(inp, out).output_shape
...
def ICNet_BN(n_classes, input_height=640, input_width=320, weights_path=None):
    inp = Input(shape=(input_height, input_width, 3))
    x = Lambda(lambda x: (x - 127.5)/255.0)(inp)
